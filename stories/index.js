...
storiesOf("Appointment", module)
  ...
  .add("Show onEdit", () => (
    <Show student="GLR" interviewer="JPR" onEdit={action("onEdit")} />
  ))
  .add("Show onDelete", () => (
    <Show student="GLR" interviewer="JPR" onDelete={action("onDelete")} />
  ))
  .add("Confirm onCancel", () => (
    <Confirm
      student="GLR"
